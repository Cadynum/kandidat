...
Den visar egentligen hur hela systemet fungerar tillsammans. Mekaniska designen, trådlösstyrning, identifiering och tryckbegränsning.
...
Oranga kurvan är avståndet mellan fingetopparna enligt den matematiska modellen och är den som styr servomotorerna. Röda kurvan är avståndet som användarens rörelse ger upphov till, också enligt den matematiska modellen. Alltså det faktiska avståndet är inte med då denna inte mäts. 

Oranga kurvan följer den röda sålänge inte trycket är för högt. Alltså rör sig robothanden här så som användaren styr.

4s:Kontakt med objekt, beräkning  av avståndet utförs och identifiering sker.

6s: 2N överstigs. Servovinklarna låser sig. Anledningen till att trycket ändå fortsätter stiga innan den stannar av beror på fördröjning i robothandens faktiska rörelser.
