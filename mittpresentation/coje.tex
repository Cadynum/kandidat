...
\begin{columns}
\column{0.6\textwidth}
\includegraphics[width=\textwidth]{../mittrapport/img/robothand}
\column{0.4\textwidth}
\textbf{Komponenter}
\begin{itemize}
	\item Meccano-hand
...
\begin{itemize}
	\item 32bitars ARM-processor
	\item Många in- och utportar
\end{itemize}
...
\begin{itemize}
	...
	\item Integritet och paketförlust
		\begin{itemize}
		\item Elektromagnetisk störning
		\item Låg latenstid för användarvänlighet
		\item Eget överföringsprotokoll
		\end{itemize}
\end{itemize}
\column{0.3\textwidth}
\centering
