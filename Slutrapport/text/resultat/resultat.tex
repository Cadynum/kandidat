\chapter{Resultat}
I detta kapitel utvärderas robothandens prestande i form av vilka objekt den kan gripa och hur väl objektidentifieringen och tryckbegränsningen fungerar.
\section{Prestanda}
...
Ett objekt med bredd på \unit{70}{mm} har identifierats av systemet vilket har genererat en maximalt tillåten kraft på \unit{2}{N}.
