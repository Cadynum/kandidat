...
\begin{subfigure}[b]{0.4\textwidth}
                \centering
                \includegraphics[width=\textwidth]{img/milk}
...
För att verifiera att den tryckbegränsande funktionen fungerar utfördes ett test som genererade datan till figur \ref{masterplot}. Figuren visar ett händelseförlopp på 15 sekunder
