...
Under de första 6 sekunderna tillåts användaren fritt styra avståndet mellan fingerspetsarna efterssom trycksensorn registrerar ett värde under det maximalt tillåtna värdet 2 N. Vid 6 sekunder greppar handen ett objekt vilket genererar ett ökat kontakttryck som tillslut överstiger gränsen. Systemet begränsar då trycket genom att hindra vidare rörelse i handen (orange linje). Användaren (röd linje) begär ett mindre avstånd mellan fingrarna vilket begränsas av systemet då detta skulle generera ett ökat kontakttryck. Vid 11 sekunder släpper användaren på trycket så det understiger 2N. Detta tillåter momentalt en rörelse vilket sedan sänker börvärdet. vid 13.5 sekunder släpper användaren objektet och trycket går då ner till 0. 
