...
\textbf{0.0--6.0 s}    & Fri styrning av avstånd mellan fingerspetsarna efterssom trycksensorns värde är lägre än  \unit{2}{N}.\\
\textbf{6.0--11.0 s} & Handen greppar objektet och kontakttrycket ökar tills gränsen överskrids. Systemet begränsar då det faktiska avståndet mellan fingerspetsarna.\\
\textbf{11.0--13.5 s} & Objektet glider ur sitt grepp vilket resulterar i ett kontakttryck under gränsvärdet. Handen tillåts då rörelse fram tills trycket återfås.  \\
\textbf{13.5--15.0 s}  & Användaren släpper objektet och trycket sjunker.
