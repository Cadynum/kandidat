\chapter{Resultat}
Det största resultatet är hela konstruktionen av robothanden och programmeringen av den. Efter utförda funktionstester har följande resultat uppnåtts. Robothanden kan:
\begin{itemize}
