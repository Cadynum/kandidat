...
\label{schemahandske}
\end{figure}
Komponenterna till styrhandsken är lödda på ett experimentkort tillsammans med Arduinon och bluetoothmodulen, och strömförsörjs av ett batteri som är reglerat till 5 Volt.
...
\end{figure}
I figuren ovan är ett kopplingsschema för en diodramp som sitter på styrhandsken. Det finns tre stycken men kopplingsschemat ser likadant ut. \emph{DATA} är kopplad till mikrokontrollen, \emph{MR} är reset och \emph{CLK} är klockpulsen.
\section{Robothanden}
\begin{figure}[H]
