...
\label{schemahandske}
\end{figure}
Komponenterna till styrhandsken är lödda på ett experimentkort tillsammans med Arduinon och bluetoothmodulen, och strömförsörjs av ett batteri som är reglerat till 5 Volt. $R_1=\unit{3.3}{k\Omega} och R_2=\unit{5}{k\Omega}. $
