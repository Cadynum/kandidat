...
\\
\begin{figure}[H]
\includegraphics[height=0.35\textheight]{img/tummecad}
\caption{Tummen}
\label{fig:tumme}
\end{figure} 
...
\section{Aktuering}
Totalt har handen åtta leder varav sex är separat styrbara. I detta avsnitt presenteras servomotorer och kraftöverföring.
\subsection{Servon}
\begin{figure}[H]
