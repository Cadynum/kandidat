...
\caption{Signalerna från figur~\ref{fig:rawflex} filtrerade med ett butterworth-filter av första ordningen med en brytfrekvens på $f_0=\unit[15]{Hz}$. Signalerna kan anta värden mellan $\unit[0-5]{V}$.}
