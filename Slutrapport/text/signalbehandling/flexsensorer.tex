...
För att filtrera bort störningarna används ett \emph{butterworthfilter} (se \ref{sec:butter}). Brytfrekvensen sätts till $f_0=\unit[15]{Hz}$ efter flera tester där den upplevda fördröjningen av robothandens rörelser balanserades mot hur ``hackigt'' handen upplevdes röra dig. De filtrerade signalerna finns i figur~\ref{fig:filterflex}.
