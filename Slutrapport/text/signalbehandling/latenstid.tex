...
\end{tabularx}
\end{table}
Den totala fördröjningen från att användaren rör på ett finger tills dess att trycket återkopplas via ledlamporna blir således 102 ms med en standardavvikelse på 3.1 ms.
