...
Låt
\begin{itemize}
    \item $G(s)$ filtrets överföringsfunktion i laplace-domänse, där vi studerar funktionens komplexa frekvens genom att sätta $s=2\pi f$. Se ekvation~\eqref{eq:butter_s}.
