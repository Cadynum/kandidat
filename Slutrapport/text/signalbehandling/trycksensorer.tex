...
\end{equation}
Relationen mellan spänning och tryck är uppmätt upp till 10 N. Från sensorns datablad (se \ref{chp:komponentlista}) finns det referensgrafer. Mätdatan kan därför extrapoleras med relativt stor säkerhet upp till sensorns maxspecifikation, 20 N.
...
\end{tabularx}
\caption{Passade värden för trycksensorerna.}
\end{table}
