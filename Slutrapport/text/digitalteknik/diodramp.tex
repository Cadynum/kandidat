...
\caption{$\unit[10]{N}$}
\end{subfigure}
\caption{Kraft återkopplas till användaren genom att tända fler dioder för högre kraft. När kraften överstiger 8 N släcks lampor från motsatt håll. Totalt kan upp 16 N visas.}
\end{figure}