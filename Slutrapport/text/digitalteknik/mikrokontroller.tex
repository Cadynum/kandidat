...
Vissa beräkningar angående kraftutslag från trycksensorerna och att beräkna avstånd mellan fingrar kräver matematik med flyttal. Arduino dock har inte hårdvarustöd för flyttal, och det emuleras med mjukvara. Strömförbrukningen blir då något högre än om det skulle finnas inbyggt stöd. 

För robothanden används \emph{Arduino Due}, en 32-bitars Atmel ARM-processor. De flesta beräkning ser med denna processor eftersom den är markant snabbare än styrhandskens mikrokontroller. 
