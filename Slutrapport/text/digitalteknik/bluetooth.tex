...
och \emph{payload}
\footnote{Datan i sig som ska överföras}. Modulerna exponerar ett seriellt interface till mikrokontrollen, där inte kontroll ges över individuella paket.
...
\comment{enligt jonas är korrumperat ett dåligt ord. men det är det man säger i datasammanhang.}
