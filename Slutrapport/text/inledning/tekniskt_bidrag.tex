...
\item Om objektet identifieras som ett av de kända kommer handen att verka för att gripa objektet med ett fördefinerat tryck, och ignorerar användarens rörelser.
\item Greppet vidhålls tills användaren visar att den vill släppa genom att öppna sin hand, då återgår robothanden till att följa användarens önskade rörelser igen
\end{enumerate}
