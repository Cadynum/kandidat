...
En av de mest avancerade robothänderna som noga kan imitera det mänskliga rörelseomfånget samt mäta vilken kraft den utsätter objekt för är Shadow Dextreous Hand utvecklad av Shadow Robot Company, \citep{Shadow_company}. Den har 24 frihetsgrader varav 20 kan aktueras oberoende av varandra. Detta kan jämföras med den mänskliga handen som har 27 frihetgrader; 4 i varje finger och 5 i tummen, resterande 6 tillskrivs förflyttning av handflata och handled. Shadow Hands 20 aktuatorer har separata PID regulatorer som kan reglera antingen fingrarnas position eller, då fingrarna är i kontakt med ett objekt, kraften som fingrarna trycker mot objektet med. Marknadspriset för en sådan hand är 115 000£ (ca 1,17 Miljoner skr) i grundutförande. \citep{Shadow_company_price}\\

Vad gäller sensorisk feedback finns festos exohand, \citep{Festo}, som styrs med en pneumatisk handske. Med hjälp av haptisk återkoppling får användaren viktig information om greppet och kan utifrån detta själv reglera handen.
