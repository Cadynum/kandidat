...
\caption{Beskrivning}
\end{figure}
I figur~\ref{fig:trycksensor} ovan syns trycksensorns position på fingertoppen. Trycksensorerna är av modell Interlink 0.5
\begin{figure}[H]
\includegraphics[height=0.5\textheight]{img/sensor}
\label{fig:monteradtopp}
\caption{Monterad finger topp med trycksensor under gummi}
\end{figure}
