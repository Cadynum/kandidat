...
Denna rapport redogör utveckling och konstruktion av en robothand med tre fingrar, vilken styrs trådlöst via en handske som användaren bär. Handsken kalibreras enkelt mot olika användares händer och mäter kontinuerligt fingrarnas läge. Robothanden är försedd med trycksensorer som visuellt återkopplar aktuellt tryck till användaren via dioder på handsken. Med matematisk modellering av robothanden tillsammans med styrsignaler till aktuatorerna uppnås en enkel grund till objektidentifiering baserad på objektets storlek. Då ett objekt identifierats ges ett referenstryck som begränsar användaren att kunna styra robothanden till ett läge som överstiger detta tryck och därmed skyddas objektet från skada. För att inte små mätstörningar ska påverka tryckbegränsningen och för att styrningen inte ska upplevas hackig filtreras signalerna. Robothandens design är framtagen dels för att uppnå intuitiv styrning och  även för att vissa typer av grepp ska kunna utföras. Utförande av dessa grepp uppnås och verifieras.

Skillnader mellan matematiska modellen och den verkliga rörelsen av robothanden begränsar antal och storlek på objekt som kan identifieras. Felkällor finns främst i den mekaniska konstruktionen och uppkommer på grund av höga toleranser och glapp. 
