...
För att inte små mätstörningar ska påverka tryckbegränsningen och för att styrningen inte ska upplevas hackig filtreras signalerna. Robothandens design är framtagen dels för att uppnå intuitiv styrning och även för att vissa typer av grepp ska kunna utföras.

Användartester visar att robothanden styrs intuitivt, och tryckåterkopplingen fungerar. Robothanden identifierar och begränsar greppkraften korrekt, men skillnader mellan den idealiserade modellen och den verkliga rörelsen begränsar antal och storlek på objekt som kan identifieras. Felkällor finns främst i den mekaniska konstruktionen och uppkommer på grund av höga toleranser och glapp.
