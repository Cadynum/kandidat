...
För att beräkna avståndet mellan fingertopparna och därmed möjliggöra objektidentifiering används en matematisk modell av handen. Genom att beräkna avståndet kan ett antal fördefinerande objekt identifieras Objektidentifieringen används sedan för att begränsa kontakttrycket.


 kan ett na uträkör att  F Den matematiska modellen används för att identifiea ett urval av fördefinerade objekt 
