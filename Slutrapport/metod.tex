...
För att mata in instruktioner från användaren används en styrhandske som gör styrningen intuitiv jämfört än att kontrollera handen via spakar eller knapptryckningar. För att mäta hur handsken deformeras används flexsensorer som ändrar resistans beroende på hur mycket de böjs. Skillnaden  


Handsken som används är en vanlig arbetshandske av textil.
Flexsensorerna är insydda i små påsar som underlättade montering av sensorerna på handsken. (Se figur)
(Bild på handsken)  
