...
\caption{HÄR SKA VARA ETT FOTO PÅ ROBOTHANDEN som visar det texten nedan beskriver}
\end{figure}
Handen består av två fingrar och en tumme som beskrivs utförligare i sina respektive avsnitt. På fingrar och tumme sitter det även plastskal som har som uppgift att skapa bättre greppytor. Handen har aktuatorer, microkontroller, bluetooth och strömförsörjning integrerat i en enda enhet.\\
Handens utformning har utgått från hur fingrarna önskas vara positionerade relativt varandra och detta verifierades i CAD-miljö utefter förmågan att utföra ett antal grepp ur Cutkoskys grepphierarki.
\begin{figure}[H]
...
\end{figure}
I figuren ovan syns de utprovade greppen, som i sin tur kan identifieras i Cutkoskys grepphierarki nedan som; fr.v. Heavy wrap; Small Diameter (2), Large Diameter (1), Prismatic Thumb-Index Finger (9) och Circular Disk (12). (Se Appendix LÖK CUTKOSKY) 
\begin{figure}[H]
\includegraphics[width=1\textwidth]{img/cutkoskys_handmodeller}
\caption{Cutkoskys grepphierarki.}
\end{figure}
...
Med utgångspunkten mänsklig motorik designades handens två identiska fingrar för att få ett människolikt rörelsemönster vilket underlättar för användaren.


\begin{figure}[H]
\includegraphics[height=0.15\textheight]{img/fingerbild}
...
\begin{figure}[H]
\includegraphics[width=0.75\textwidth]{img/1vs2frihets}
\caption{En och två kontrollerbara frihetsgrader.}
\end{figure}

Med två frihetsgrader finns ett fält av möjliga positioner för fingertoppen att befinna sig i för varje läge handen står i, vilket minskar behovet av att flytta hela handen vid små justeringar av grepp.

\begin{figure}[H]
Bild tumme

\caption{Beskrivning}
\end{figure} Tummen har endast två separata frihetsgrader och sitter fast positionerad i handen för att kunna utföra ett pincettgrepp med finger 1. Detta är tillräckligt för möjliggöra ett flertal olika grepp, men jämfört med den mänskliga tummen som kan möta samtliga fingertoppar är detta ett stelt utförande.
...
\label{sec:mikro}
De använda microkontrollerna är Arduino micro och Arduino Due.
\section{Trådlös kommunikation}
För att möjliggöra kommunikation trådlöst mellan kontrollhandsken och robothanden
används två prototyp-versioner av Bluetooth Mate Silver. Enheten är godkänd för Bluetooth klass 2, vilket bl a innebär låg strömförbrukning (genomsnittligt 2.5mW vid aktiv
användning) och överföringar på upp till 10m. Bluetoothenheten har en överföringskapacitet på 115200bps, inkluderat metadata.
