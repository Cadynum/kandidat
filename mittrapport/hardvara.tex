...
En 32 bitars Arduino Due används för robothanden. Eftersom alla reglerberäkning sker i robothanden i sig, är prestanda viktigt. Arduino Due är en arduinon med kraftigast processor. Eftersom det inte finns hårdvarustöd för flyttal\footnote{Tal som har en varierande decimalposition} i någon arduino, är 32 bitar extra viktigt för att effektivt kunna beräkna använda fixpunkt\footnote{Tal som har en fast decimalposition. Punktens plats måste beräknas manuellt i en separat variabel.} med tillräcklig precision.
