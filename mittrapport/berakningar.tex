...
\begin{figure}[H]
\includegraphics[width=0.5\textwidth]{img/momentdiagram}
\caption{Moment som krävs i led 1 och 2 vid vertikal last.}
\end{figure}

Diagramemt visar momentet som krävs i lederna vid 30 olika positioner där vinklarna $\alpha_1$ och $\alpha_2$ har förändrats med samma vinkel varje position. Position 1 är då fingret pekar nästan rakt neråt och position 30 är båda vinklarna ca 90 grader. Från diagrammet framgår att högsta momentet uppstår i led 1 och är 0.553 [Nm]. För att vara på säkra sidan gjordes samma beräkning fast $\alpha_2$ hölls på 180 grader. Då uppstod som väntat största momentet i led 1 då fingret hölls rakt i horisontellt läge. Detta moment uppgick till 0.639 [Nm].
