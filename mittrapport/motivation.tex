\section{Mekanisk design}
 ...
 Robothanden består av fyra huvuddelar, två fingrar, en tumme och en handflata. Anledningen är att ett färre antal fingrar medför att mer tid kan läggas på att konstruera välfungerande fingrar. När ett väl fungerande finger konstruerats är det möjligt att i framtida projekt kopiera designen och öka antalet fingrar på handen. Med utgångspunkten mänsklig motorik designades handens två identiska fingrar för att få ett människolikt rörelsemönster. 
\begin{figure}[ht]
\includegraphics[width=0.3\textwidth]{img/Fingerbild}
\caption{Översikt finger}
\end{figure}
