...
\caption{Två kontrollerbar frihetsgrad.}
\end{figure}
\end{minipage}
\\
...
\end{figure}
Aktuatorer för samtliga leder är Blue bird servon med ett vridmoment på 1.42Nm, en reaktionstid på 0.17 sekunder och vikt på 52 gram. För dimensionerande beräkningar se Appendix 6.1.
